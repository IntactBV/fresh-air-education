                ...
                <div className="switch">
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                        <div className="panel space-y-5">
                            ...
                            <label className="relative h-6 w-12" aria-label="Public Profile">
                        ...
                        <div className="panel space-y-5">
                            ...
                            <label className="relative h-6 w-12" aria-label="Show my email">
                        ...
                        <div className="panel space-y-5">
                            ...
                            <label className="relative h-6 w-12" aria-label="Enable keyboard shortcuts">
                        ...
                        <div className="panel space-y-5">
                            ...
                            <label className="relative h-6 w-12" aria-label="Hide left navigation">
                        ...
                        <div className="panel space-y-5">
                            ...
                            <label className="relative h-6 w-12" aria-label="Advertisements">
                        ...
                        <div className="panel space-y-5">
                            ...
                            <label className="relative h-6 w-12" aria-label="Social Profile">
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                            ...
                            <div className="panel space-y-5">
                                ...
                                <label className="relative h-6 w-12">
                                    <span className="sr-only">Deactivate Account</span>
